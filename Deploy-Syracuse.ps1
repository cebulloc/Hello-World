...
<#
.SYNOPSIS
    Syracuse Workstation Deployment
.DESCRIPTION
    Deploys tools to the Syracuse workstation.
    Run from \\e4-arch2\staging\Syracuse\Deploy-Syracuse\ or a mapped drive.
    ...
    PRE-STAGE in .\Installers\:
      ...
      install-poetry.py                      (Poetry installer script)
      Git-*-64-bit.exe
...
$instDir  = "$env:TEMP\Syracuse_Installers"
...
Write-Log '================================================================'
Write-Log "Syracuse Deployment - $env:COMPUTERNAME"
